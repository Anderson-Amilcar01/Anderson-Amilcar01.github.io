...
$("#botonPechar").keydown(function(e){if (e.which!=9){PechaVentana();}});$("#suggestPost").keydown(function(e){if (e.which!=9){$("#suggestPost").click();}})
   ...
   menuLateral='';
   menuActividades='<h2></h2><table width="150" border="0"><tr><td><p><a href="javascript:irA(0)" title="Melanie"><strong>1</strong></a></p></td><td><p><a href="javascript:irA(1)" title="Alexandra Alvarado"><strong>2</strong></a></p></td><td><p><a href="javascript:irA(2)" title="Fernado"><strong>3</strong></a></p></td><td><p><a href="javascript:irA(3)" title="Javier Vanegas"><strong>4</strong></a></p></td><td><p><a href="javascript:irA(4)" title="Sarai Hernandez"><strong>5</strong></a></p></td></tr><tr></tr></table>';
...
taboaContidos[0]=new act("Melanie","Melanie","","<object width='100%' height='420' type='text/html' data='Sociales/Sociales.htm'></object>",true,"",true,false,false);
taboaContidos[1]=new act("Alexandra Alvarado","Alexandra Alvarado","","<object width='100%' height='420' type='text/html' data='Sociales_Alexa/Sociales_Alexa.htm'></object>",true,"",true,false,false);
taboaContidos[2]=new act("Fernado","Fernado","","<object width='100%' height='420' type='text/html' data='Sociales_fdzin/Sociales_fdzin.htm'></object>",true,"",true,false,false);
taboaContidos[3]=new act("Javier Vanegas","Javier Vanegas","","<object width='100%' height='420' type='text/html' data='SP_de_GF/SP_de_GF.htm'></object>",true,"",true,false,false);
taboaContidos[4]=new act("Sarai Hernandez","Sarai Hernandez","","<object width='100%' height='420' type='text/html' data='Ahorcados/Ahorcados.htm'></object>",true,"",true,false,false);
