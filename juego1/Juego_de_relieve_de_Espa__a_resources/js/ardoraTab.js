...
$(this).css("-webkit-box-shadow", " 0px 0px 0px rgba(50, 50, 50, 0.5)");$(this).css("box-shadow", "0px 0px 0px rgba(50, 50, 50, 0.75)");
}).mouseleave(function () {
$(this).css("-webkit-box-shadow", " 4px 4px 4px rgba(50, 50, 50, 0.5)");$(this).css("box-shadow", "4px 4px 4px rgba(50,50,50,0.5)");
}).mousedown(function () {itemSel=parseInt($.trim($(this).attr("id").substring(3,20)));});
...
if ($(".txtCell_input").length !=0) { $(".txtCell_input").css("background-color","rgba("+hexToRgb(colorBack).r+","+hexToRgb(colorBack).g+","+hexToRgb(colorBack).b+",1)"); $(".txtCell_input").css("color",colorText);};
...
if ($(".txtCell_input").length !=0) {var color2=colorSele;var color1=colorBack;
$(".txtCell_input").css("background","-webkit-radial-gradient(center, ellipse, "+color1+","+color2+")");
$(".txtCell_input").css("background","-moz-radial-gradient(center,ellipse, "+color1+", "+color2+")");
$(".txtCell_input").css("background","-ms-radial-gradient(center, ellipse, "+color1+", "+color2+")");
$(".txtCell_input").css("background","-o-radial-gradient(center, ellipse, "+color1+", "+color2+")");
$(".txtCell_input").css("background","radial-gradient(ellipse at center, "+color1+", "+color2+")");
$(".txtCell_input").css("filter","progid:DXImageTransform.Microsoft.gradient(startColorstr='"+color1+"', endColorstr='"+color2+"')");}
